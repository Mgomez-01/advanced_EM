...
'@ define material: test_filter/Copper (pure)
...
'@ define material: Rogers RO4350B LoPro (lossy)

'[VERSION]2023.0|32.0.1|20220912[/VERSION]
With Material
     .Reset
     .Name "Rogers RO4350B LoPro (lossy)"
     .Folder ""
.FrqType "all"
.Type "Normal"
...
'[VERSION]2023.0|32.0.1|20220912[/VERSION]
Solid.ChangeMaterial "component1:solid1", "Rogers RO4350B LoPro (lossy)"
...
Dim outputPath As String
    ...
    fileNo = FreeFile
    Open outputPath For Input As #fileNo
...
'@ rename port: test_filter:port1 to: port1

'[VERSION]2023.0|32.0.1|20220912[/VERSION]
Port.RenameItem "test_filter:port1", "port1"

'@ rename port: test_filter:port2 to: port2

'[VERSION]2023.0|32.0.1|20220912[/VERSION]
Port.RenameItem "test_filter:port2", "port2"

'@ delete port folder: test_filter

'[VERSION]2023.0|32.0.1|20220912[/VERSION]
Port.DeleteFolder "test_filter"
...
With Port 
     ...
     .ClipPickedPortToBound "False"
     .Xrange "-50", "-50"
     .Yrange "-54.9792458", "54.9792458"
     .Zrange "-29.9967458", "30.2667458"
     .XrangeAdd "0.0", "0.0"
     .YrangeAdd "0.0", "0.0"
     .ZrangeAdd "0.0", "0.0"
     .SingleEnded "False"
